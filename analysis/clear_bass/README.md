...
| File | What |
|---|---|
| `CB_6bandEQ_iir_coef.csv` | bands 1–5 (400 Hz … 16 kHz): 6 sample rates × 5 bands × 21 levels (−10..+10 dB). Band-pass `b0, b1, b2, fb1, fb2` with b1 = 0 and b2 = −b0, run as `y = b0·x + b1·x1 + b2·x2 + fb1·y1 + fb2·y2` (so fb1, fb2 are the usual a1, a2 negated). Each band is added to the dry signal. |
